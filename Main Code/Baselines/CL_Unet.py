...
best_model_path = f'/home/tushar/Weather Prediction/Code/Baselines/Checkpoints/unet_best_model{pred_var}.pth'
last_model_path = f'/home/tushar/Weather Prediction/Code/Baselines/Checkpoints/unet_last_model{pred_var}.pth'
...
def save_metrics_to_json(metrics_per_step, out_steps, pred_var, gap, filename="/home/tushar/Weather Prediction/Code/Main Code/Results/Direct Forecasting Results/CL_Unet_Direct_Forecasting_result.json"):
