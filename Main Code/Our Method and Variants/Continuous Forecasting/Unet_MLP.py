...
pred_var = "z_500"
in_steps = 3
out_steps = 3         #keep this equal to how many lead times in future you want to predict
gap = 1               #this represents the gap at which you want to forecast, starting with 1 (for imeediate forecasting)

print("Creating the dataset")
# Create datasets and dataloaders
train_dataset = WeatherGridDataset(train_list,in_steps,out_steps,pred_var,gap=gap)
print("Freeing up memory from train_list...")
del train_list
val_dataset = WeatherGridDataset(val_list,in_steps,out_steps,pred_var,gap=gap)
print("Freeing up memory from val_list...")
del val_list
test_dataset = WeatherGridDataset(test_list,in_steps,out_steps,pred_var,gap=gap)
...
best_model_path = f'/home/anonymus/Weather Prediction/Code/Main Code/Checkpoints/continuous_unet_mlp_best_model{pred_var}.pth'
last_model_path = f'/home/anonymus/Weather Prediction/Code/Main Code/Checkpoints/continuous_unet_mlp_last_model{pred_var}.pth'
...
def save_metrics_to_json(metrics_per_step, out_steps, pred_var, gap, filename="/home/anonymus/Weather Prediction/Code/Main Code/Results/Continuous Forecasting Results/Unet_MLP_continuous_result.json"):
