...
model = UNetWithAttention(final_channels=out_steps,lat=lat,lon=lon)
model = model.to(device)
optimizer = optim.AdamW(model.parameters(), lr=5e-4, weight_decay=1e-5)
criterion = LatitudeWeightedRMSELoss(latitude_tensor)

best_model_path = f'/home/anonymus/Weather Prediction/Code/Main Code/Checkpoints/continuous_unet_sattn_best_model{pred_var}.pth'
last_model_path = f'/home/anonymus/Weather Prediction/Code/Main Code/Checkpoints/continuous_unet_sattn_last_model{pred_var}.pth'
...
def save_metrics_to_json(metrics_per_step, out_steps, pred_var, gap, filename="/home/anonymus/Weather Prediction/Code/Main Code/Results/Continuous Forecasting Results/Unet_sattn_continuous_result.json"):
