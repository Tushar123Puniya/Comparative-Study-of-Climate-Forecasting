...
best_model_path = f'/home/tushar/Weather Prediction/Code/Main Code/Checkpoints/discrete_unet_sattn2_best_model{pred_var}.pth'
last_model_path = f'/home/tushar/Weather Prediction/Code/Main Code/Checkpoints/discrete_unet_sattn2_last_model{pred_var}.pth'
...
def save_metrics_to_json(metrics_per_step, out_steps, pred_var, gap, filename="/home/tushar/Weather Prediction/Code/Main Code/Results/Direct Forecasting Results/Unet_Direct_Forecasting_result.json"):
