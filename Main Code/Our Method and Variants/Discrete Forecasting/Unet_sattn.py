...
best_model_path = f'/home/anonymus/Weather Prediction/Code/Main Code/Checkpoints/discrete_unet_sattn_best_model{pred_var}.pth'
last_model_path = f'/home/anonymus/Weather Prediction/Code/Main Code/Checkpoints/discrete_unet_sattn_last_model{pred_var}.pth'
...
def save_metrics_to_json(metrics_per_step, out_steps, pred_var, gap, filename="/home/anonymus/Weather Prediction/Code/Main Code/Results/Direct Forecasting Results/Unet_sattn_Direct_Forecasting_result.json"):
