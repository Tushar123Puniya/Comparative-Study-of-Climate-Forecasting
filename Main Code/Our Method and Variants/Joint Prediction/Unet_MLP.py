...
best_model_path = f'/home/anonymus/Weather Prediction/Code/Main Code/Checkpoints/unet_mlp_best_model{pred_var}.pth'
last_model_path = f'/home/anonymus/Weather Prediction/Code/Main Code/Checkpoints/unet_mlp_last_model{pred_var}.pth'
...
def save_metrics_to_json(metrics_per_step, out_steps, pred_var, gap, filename="/home/anonymus/Weather Prediction/Code/Main Code/Results/Joint Forecasting Results/Unet_MLP_alltogether_result.json"):
